...
pub trait DefEvmExt {
	...
	/// A `Gasometer` event proxied by the bool runtime to this host function.
	/// evm_gasometer -> bool_runtime -> host.
	...
	/// A `Runtime` event proxied by the bool runtime to this host function.
	/// evm_runtime -> bool_runtime -> host.
